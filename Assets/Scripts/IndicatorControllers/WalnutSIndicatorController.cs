...
public class WalnutSIndicatorController : MonoBehaviour {
	...
	void OnEnable() {
		WalnutSmallController.onWalnutSmallCubeInSlot += greenLight;
		WalnutSmallController.onWalnutSmallCubeOutOfSlot += redLight;
	}
