...
public class CherryMIndicatorController : MonoBehaviour {
	...
	void OnEnable() {
		CherryMediumController.onCherryMediumCubeInSlot += greenLight;
		CherryMediumController.onCherryMediumCubeOutOfSlot += redLight;
	}
