...
public class CherrySIndicatorController : MonoBehaviour {
	...
	void OnEnable() {
		CherrySmallController.onCherrySmallCubeInSlot += greenLight;
		CherrySmallController.onCherrySmallCubeOutOfSlot += redLight;
	}
