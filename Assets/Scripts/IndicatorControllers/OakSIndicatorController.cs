...
public class OakSIndicatorController : MonoBehaviour {
	...
	void OnEnable() {
		OakSmallController.onOakSmallCubeInSlot += greenLight;
		OakSmallController.onOakSmallCubeOutOfSlot += redLight;
	}
